...
class FancyStyle implements tjson.interfaces.EncodeStyle
{
  ...
  {
    return if (n < charTimesNCache.length) charTimesNCache[n]; else charTimesNCache[n] = charTimesN(n - 1) + tab;
  }
}
